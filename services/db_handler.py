...
class DBHandler:
    ...
    def get_doc_by_id(self, id) -> dict | bool:
    ...
    def get_user_credentials(self, username) -> dict | bool:
    ...
    def get_user_by_id(self, id) -> dict | bool:
    ...
    def add_todo(self, name, description, completed, created_by) -> bool:
    ...
    def get_todos_by_user_id(self, id) -> list | bool:
        user_id = ObjectId(id)
    ...
    def get_todo_by_id(self, id):
        ...
        try:
            ...
            printMessage.debug(f"get_todo_by_id() -> User by id: {todo_by_id}")
            printMessage.debug(f"get_todo_by_id() -> Type User by id: {type(todo_by_id)}")
            return todo_by_id
        except OperationFailure as e:
            print(f"{variables.ERROR_MSG} Obtaining todo by id, details: {e}")
            return False
 
    def update_todo(self, id, name, description, completed, created_by) -> bool:
    ...
    def delete_todo(self, id, created_by) -> bool:
